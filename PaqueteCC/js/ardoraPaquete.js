...
window.open("avalia/avalia.htm","width=800,height=600,scrollbars='");
   ...
   menuLateral='';
   menuActividades='<h1></h1><a href="javascript:irA(0)" title="Sopa de letras de varios temas">1 </a><a href="javascript:irA(1)" title="Test variado">2 </a><a href="javascript:irA(2)" title="Crucigrama sobre temas varios">3 </a><a href="javascript:irA(3)" title="Rompecabezas">4 </a><a href="javascript:irA(4)" title="Juego de memoria">5 </a></tr><tr><a href="javascript:irA(5)" title="Relacionar equivalencias">6 </a>';
...
taboaContidos[0]=new act("Sopa de letras de varios temas","Sopa de letras de varios temas","","<object width='100%' height='420' type='text/html' data='SOPA_DE_LETRAS/SOPA_DE_LETRAS.htm'></object>",true,"",true,true,true);
taboaContidos[1]=new act("Test variado","Test variado","","<object width='100%' height='420' type='text/html' data='TEST/TEST.htm'></object>",true,"",true,true,true);
taboaContidos[2]=new act("Crucigrama sobre temas varios","Crucigrama sobre temas varios","","<object width='100%' height='420' type='text/html' data='CRUCIGRAMA/CRUCIGRAMA.htm'></object>",true,"",true,true,true);
taboaContidos[3]=new act("Rompecabezas","Rompecabezas","","<object width='100%' height='420' type='text/html' data='PUZZLE/PUZZLE.htm'></object>",true,"",true,true,true);
taboaContidos[4]=new act("Juego de memoria","Juego de memoria","","<object width='100%' height='420' type='text/html' data='memoria/memoria.htm'></object>",true,"",true,true,true);
taboaContidos[5]=new act("Relacionar equivalencias","Relacionar equivalencias","","<object width='100%' height='420' type='text/html' data='EQUIVALENCIAS_1/EQUIVALENCIAS_1.htm'></object>",true,"",true,true,true);
