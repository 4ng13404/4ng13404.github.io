...
$(".imaCell_img").css("background","-webkit-gradient(linear, left top, left bottom, from("+color1+"), to("+color2+"))");
$(".imaCell_img").css("background","-webkit-linear-gradient("+color1+", "+color2+")");
$(".imaCell_img").css("background","-moz-linear-gradient(top, "+color1+", "+color2+")");
$(".imaCell_img").css("background","-ms-linear-gradient("+color1+", "+color2+")");
$(".imaCell_img").css("background","-o-linear-gradient("+color1+", "+color2+")");
$(".imaCell_img").css("background","linear-gradient("+color1+", "+color2+")");
$(".imaCell_img").css("filter","progid:DXImageTransform.Microsoft.Alpha(startColorstr='"+color1+"', endColorstr='"+color2+"')");}
