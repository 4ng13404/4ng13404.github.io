...
$("#botonPechar").keydown(function(e){if (e.which!=9){PechaVentana();}});$("#suggestPost").keydown(function(e){if (e.which!=9){$("#suggestPost").click();}})
   ...
   menuLateral='';
   menuActividades='<h2 class="heading"></h2><div class="content"><ul><table width="140" border="0"><tr><td><li class="first"><a href="javascript:irA(0)" title="Ordenar frases">1</a></li></td><td><li class="first"><a href="javascript:irA(1)" title="Ordenar párrafos">2</a></li></td><td><li class="first"><a href="javascript:irA(2)" title="Colorear según Leyenda">3</a></li></td></tr></table></ul></div>';
...
taboaContidos[0]=new act("Ordenar frases","Ordenar frases","","<object width='100%' height='420' type='text/html' data='OrdenaFrases/OrdenaFrases.htm'></object>",true,"",true,true,true);
taboaContidos[1]=new act("Ordenar párrafos","Ordenar párrafos","","<object width='100%' height='420' type='text/html' data='OrdenaParrafos/OrdenaParrafos.htm'></object>",true,"",true,true,true);
taboaContidos[2]=new act("Colorear según Leyenda","Colorear según Leyenda","","<object width='100%' height='420' type='text/html' data='ColoreaLeyenda/ColoreaLeyenda.htm'></object>",true,"",true,true,true);
