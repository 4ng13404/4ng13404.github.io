...
window.open("avalia/avalia.htm","width=800,height=600,scrollbars='");
   ...
   menuLateral='<h2 class="heading">MENU</h2><div class="content"><ul><li class="first"><a href="https://4ng13404.github.io/PAQUETE/English/English.htm" target="_blank">1. Relate: So and Such</a></li><li class="first"><a href="https://4ng13404.github.io/PAQUETE/JUEGOTEST/JUEGOTEST.htm" target="_blank">2. Test: Present Simple</a></li><li class="first"><a href="https://4ng13404.github.io/PAQUETE/educa/educa.htm" target="_blank">3. Fill: the Missing Adverbs</a></li><li class="first"><a href="https://4ng13404.github.io/PAQUETE/Juego_para_la_feria_evaluado/Juego_para_la_feria_evaluado.htm" target="_blank">4. Order phrases: Prepositions of movement</a></li><li class="first"><a href="https://4ng13404.github.io/PAQUETE/JUEGOWRITE/JUEGOWRITE.htm" target="_blank">5. Order letters: Indefinite pronouns</a></li><li class="first"><a href="https://4ng13404.github.io/PAQUETE/letter_soup/letter_soup.htm" target="_blank">6. Soup Letter: Regular and Irregular verbs</a></li></ul></div>';
   menuActividades='<h2 class="heading"></h2><div class="content"><ul><table width="140" border="0"><tr><td><li class="first"><a href="javascript:irA(0)" title="Does this uses so or such?">1</a></li></td><td><li class="first"><a href="javascript:irA(1)" title="Answer my questions...">2</a></li></td><td><li class="first"><a href="javascript:irA(2)" title="Which adverb?">3</a></li></td><td><li class="first"><a href="javascript:irA(3)" title="Do you know the preposittion?">4</a></li></td><td><li class="first"><a href="javascript:irA(4)" title="Wriite the pronoun.">5</a></li></td></tr><tr><td><li class="first"><a href="javascript:irA(5)" title="Can you find the verbs?">6</a></li></td></tr></table></ul></div>';
...
taboaContidos[0]=new act("Does this uses so or such?","Does this uses so or such?","","<object class='ardobject' width='100%' height='420' type='text/html' data='English/English.htm'></object>",false,"",true,true,true);
taboaContidos[1]=new act("Answer my questions...","Answer my questions...","","<object class='ardobject' width='100%' height='420' type='text/html' data='JUEGOTEST/JUEGOTEST.htm'></object>",false,"",true,true,true);
taboaContidos[2]=new act("Which adverb?","Which adverb?","","<object class='ardobject' width='100%' height='420' type='text/html' data='educa/educa.htm'></object>",false,"",true,true,true);
taboaContidos[3]=new act("Do you know the preposittion?","Do you know the preposittion?","","<object class='ardobject' width='100%' height='420' type='text/html' data='Juego_para_la_feria_evaluado/Juego_para_la_feria_evaluado.htm'></object>",false,"",true,true,true);
taboaContidos[4]=new act("Wriite the pronoun.","Wriite the pronoun.","","<object class='ardobject' width='100%' height='420' type='text/html' data='JUEGOWRITE/JUEGOWRITE.htm'></object>",false,"",true,true,true);
taboaContidos[5]=new act("Can you find the verbs?","Can you find the verbs?","","<object class='ardobject' width='100%' height='420' type='text/html' data='letter_soup/letter_soup.htm'></object>",false,"",true,true,true);
